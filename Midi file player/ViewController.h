...
@property (weak, nonatomic) IBOutlet UIScrollView *playerView;

@property (weak, nonatomic) IBOutlet UILabel *labelSleep;

@property (weak, nonatomic) IBOutlet UILabel *labelLocalSound;

@property (weak, nonatomic) IBOutlet UILabel *labelForLocalSoundSwitch;

@property (weak, nonatomic) IBOutlet UILabel *labelMIDIthru1;

@property (weak, nonatomic) IBOutlet UILabel *labelShowSYSEX;

@property (weak, nonatomic) IBOutlet UILabel *labelFilterSYSEX;

@property (weak, nonatomic) IBOutlet UILabel *labelPlayBackground;

@property (weak, nonatomic) IBOutlet UILabel *labelUseDrumSet0;
...
@property (weak, nonatomic) IBOutlet UILabel *labelTranspose;

@property (weak, nonatomic) IBOutlet UILabel *labelTranspose1;

@property (weak, nonatomic) IBOutlet UILabel *labelNowLen;

@property (weak, nonatomic) IBOutlet UILabel *labelAutoNext;
...
@property (weak, nonatomic) IBOutlet UIButton *buttonMIDIdevices;
- (IBAction)buttonMIDIdevicesPressed:(id)sender;

@property (weak, nonatomic) IBOutlet UILabel *labelChordBig;
@property (weak, nonatomic) IBOutlet UILabel *labelChordBigS;
...
@property (weak, nonatomic) IBOutlet UILabel *labelBatteryMode;

@property (weak, nonatomic) IBOutlet UILabel *labelInstrument;
@property (weak, nonatomic) IBOutlet UILabel *labelInstrNumb;

 
@property (weak, nonatomic) IBOutlet UILabel *labelSoundIsOff;
